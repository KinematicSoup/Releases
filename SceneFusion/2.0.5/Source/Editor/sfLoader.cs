...
namespace KS.SceneFusion.Client.Unity.Editor
{
    ...
    internal class sfLoader
    {
        ...
        public UObject CreateStandInAssetWithGuid(UObject standIn, string guid, bool isLibraryAsset, long fileId = 0)
        {
            ...
            string path = sfPaths.Temp + "StandIn" + sfUnityUtils.GetUObjectId(standIn);
            ...
            if (isLibraryAsset)
            {
                ...
                {
                    AssetDatabase.CreateFolder(ksPathUtils.Clean(sfPaths.Temp), "StandIn" +
                        sfUnityUtils.GetUObjectId(standIn));
                }
                else
                {
