...
namespace KS.SceneFusion.Client.Unity.Editor
{
    ...
    public class sfTerrainEditor : ksOverrideEditor
    {
        ...
        public class Tools
        {
            ...
            public const int PAINT_TEXTURE = 1;
            public const int PLACE_TREE = 2;
            public const int PLACE_DETAIL = 3;
            public const int TRANSFORM = 4;
            public const int PAINT_HOLE = 5;
        }
            ...
            get
            {
                if (m_roSelectedLayer == null)
                {
                    ...
                    m_roSelectedLayer = new ksReflectionObject(m_editorAssembly,
                        ...
                        .Call("GetSingleton", roPaintTextureTool.Type, typeof(SceneView))
#else
            ...
            get
            {
                if (m_roSelectedDetail == null)
                {
                    ...
                    m_roSelectedDetail = new ksReflectionObject(m_editorAssembly,
                        "UnityEditor.EditorTools.EditorToolManager")
#if UNITY_6000_5_OR_NEWER
                        .Call("GetSingleton", roPaintDetailsTool.Type, typeof(SceneView))
#else
        ...
        protected override void OnEnable()
        {
            ...
            m_roActiveTerrainInspectorField.SetValue(sfUnityUtils.GetUnityId(BaseEditor));
