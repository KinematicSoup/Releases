...
namespace KS.SceneFusion.Client.Unity.Editor
{
    ...
    public class sfGameObjectTranslator : sfBaseUObjectTranslator
    {
        ...
        private Dictionary<ulong, sfObject> m_uobjectIdToSFObjectMap = new Dictionary<ulong, sfObject>();
        ...
        public override void OnSessionDisconnect()
        {
            ...
            m_uobjectIdToSFObjectMap.Clear();
        ...
        private void AddMapping(sfObject obj, GameObject gameObject)
        {
            ...
            m_uobjectIdToSFObjectMap[sfUnityUtils.GetUObjectId(gameObject)] = obj;
        }
        ...
        private sfObject RemoveMapping(GameObject gameObject)
        {
            ...
            m_uobjectIdToSFObjectMap.Remove(sfUnityUtils.GetUObjectId(gameObject));
            return obj;
        }
        ...
        private void OnDeleteGameObject(ulong uobjectId)
        {
            // Do not remove the sfObject so it will be reused if the game object is recreated and references to it
            // will be preserved.
            sfObject obj;
            if (!m_uobjectIdToSFObjectMap.TryGetValue(uobjectId, out obj) || !obj.IsSyncing)
            {
                return;
            }
            // Sync changed hierarchies before deleting the object in case descendants of the object were
