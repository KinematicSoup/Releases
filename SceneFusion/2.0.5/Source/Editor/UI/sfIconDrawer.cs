...
namespace KS.SceneFusion.Client.Unity.Editor
{
    ...
    public class sfIconDrawer
    {
        ...
        public void Start()
        {
            ...
            EditorApplication.projectWindowItemByEntityIdOnGUI += DrawProjectItem;
#else
        ...
        /// <param name="uobjectId">Id of game object to draw icons for.</param>
        /// <param name="area">area the game object label was drawn in.</param>
#if UNITY_6000_4_OR_NEWER
        private void DrawHierarchyItem(EntityId uobjectId, Rect area)
#else
        private void DrawHierarchyItem(int uobjectId, Rect area)
#endif
        {
            UObject uobj = sfUnityUtils.GetUObject(uobjectId);
            if (uobj == null)
            {
                return;
            }
        ...
        /// <param name="uobjectId">Id of asset to draw icons for.</param>
        /// <param name="area">area the asset was drawn in.</param>
#if UNITY_6000_4_OR_NEWER
        private void DrawProjectItem(EntityId uobjectId, Rect area)
#else
        private void DrawProjectItem(int uobjectId, Rect area)
#endif
        {
            UObject asset = sfUnityUtils.GetUObject(uobjectId);
