...
namespace KS.Reactor.Client.Unity.Editor
{
    ...
    public class ksInitializer
    {
        ...
        private static void Init()
        {
            ...
            ksAnalytics.Initialize(ksReactor.Version);
            ...
            if (!Application.isPlaying)
            {
                ...
                if (isNewOrUpdate || (SessionState.GetBool(ksGettingStarted.SESSION_STATE, true) && ksReactorConfig.Instance.ShowGettingStartedScreen))
                {
                    ksGettingStarted.Get().Open();
                    SessionState.SetBool(ksGettingStarted.SESSION_STATE, false);
                }
            }
...
#pragma warning restore
            ...
            ksReactorConfig.Instance.Build.LastBuildVersion = ksReactor.Version.ToString();
            EditorUtility.SetDirty(ksReactorConfig.Instance);
            AssetDatabase.SaveAssets();
        ...
        private static void DisplayUpgradeMessage(string details, bool error = false)
        {
            ...
            {
                title += " Error";
                details = "Could not update your project to version " + ksReactor.Version + ".\n" + details +
                    "\nContinue anyway?";
            ...
            {
                details = "Your project was automatically updated to version " + ksReactor.Version + ".\n" + details;
