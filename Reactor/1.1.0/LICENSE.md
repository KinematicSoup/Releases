Reactor Multiplayer Engine and Scene Fusion
...
Subject to the terms and conditions of this Agreement, KinematicSoup hereby grants you a limited, non-exclusive, non-transferable, non-sublicensable license to:
 ...
 a. Use the Software on Licensed Platforms: Install, access, and use the Software on the platforms specified in your purchase or subscription.

 b. Develop and Deploy Applications: Create, develop, and deploy applications that incorporate the Software for internal use or distribution in accordance with this Agreement.
...
a. Computational Abuse. Use the Software for cryptocurrency mining, password cracking, distributed denial‑of‑service attacks, or other computationally‑ or bandwidth‑intensive activities unrelated to normal real‑time collaboration or multiplayer gaming.

b. Illegal or Harmful Content. Use the Software to create, distribute or host any content that is unlawful, defamatory, harassing, harmful, obscene, infringing, or otherwise objectionable.

c. Reputation Harm. Engage in any activity that harms KinematicSoup’s reputation or goodwill.

d. Reverse Engineering. Decompile, disassemble, reverse‑engineer, or otherwise attempt to derive source code, algorithms or network protocols from the Software.

e. Derivative Works & Redistribution. Modify, create derivative works of, redistribute, sublicense, sell or rent any part of the Software or Documentation.

f. Infrastructure Interference. Hack, probe, scan or test the vulnerability of KinematicSoup’s servers or network infrastructure, or interfere with the operation of the Software.

g. Bug Exploitation. Exploit or publicly disclose any security vulnerability or bug in the Software, except that you may report such issues to bugs@kinematicsoup.com.

h. Unlicensed Platforms. Use the Software on any platform, service or environment for which you have not obtained KinematicSoup’s prior written consent.

i. Policy Violations. Use the Software in violation of this Agreement or KinematicSoup’s Privacy Policy.

j. Trademark Misuse. Use any trademarks, service marks, logos or trade names confusingly similar to “KinematicSoup” or the names of its products.

5. Fees, Payment & No Refunds
a. Paid Licenses: Except as expressly provided for in Section 2.3 (Self-Hosting Permission), use of the Software may require payment of License Fees as specified in the applicable purchase or subscription terms.

b. No Cost Self-Hosting: Deployment and operation of self-hosted multiplayer instances with up to 32 concurrent players per instance are permitted at no cost and do not trigger any License Fees.

c. No Refunds: All payments made for licenses are non-refundable unless otherwise stated in a separate written agreement with KinematicSoup.
...
b. Your use of the Software in violation of law or third‑party rights; or
c. Content you create or distribute using the Software.
...
If you have any questions about this Agreement, please contact us at:
 KinematicSoup Technologies Ltd.
