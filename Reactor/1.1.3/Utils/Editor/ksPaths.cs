...
namespace KS.Reactor.Client.Unity.Editor
{
    ...
    public static class ksPaths
    {
        ...
        /// <summary>Server runtime project build directory</summary>
        public static string ServerRuntimeProjectDir
        {
            get { return External + "build/"; }
        }

        /// <summary>Server runtime project.</summary>
        public static string ServerRuntimeProject
        {
            get { return ServerRuntimeProjectDir + "KSServerRuntime.csproj"; }
        }
