...
namespace KS.Reactor.Client.Unity
{
    ...
    public class ksTransformPrecisions
    {
        ...
        [Tooltip("The accuracy of quantized position values synced over the network. 0 = full float precision value")]
        [Min(-1.0f)]
        public float Position = ksCompressionConstants.DEFAULT_POSITION_PRECISION;

        /// <summary>Rotation network precision.</summary>
        [Tooltip("The accuracy of quantized rotation values synced over the network. 0 = full float precision value")]
        [Min(-1.0f)]
        public float Rotation = ksCompressionConstants.DEFAULT_ROTATION_PRECISION;

        /// <summary>Scale network precision.</summary>
        [Tooltip("The accuracy of quantized scale values synced over the network. 0 = full float precision value")]
        [Min(-1.0f)]
