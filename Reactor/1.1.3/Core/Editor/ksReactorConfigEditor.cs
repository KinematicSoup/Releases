...
namespace KS.Reactor.Client.Unity.Editor
{
    ...
    public class ksReactorConfigEditor : UnityEditor.Editor, IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(version, new GUIContent("Reactor Version"));
#else

            EditorGUILayout.LabelField("<b>Reactor Version: </b> " + 
                (target as ksReactorConfig).Version.ToString(), m_rtfLabelStyle);
#endif
            SerializedProperty showGettingStarted = serializedObject.FindProperty(
                nameof(ksReactorConfig.ShowGettingStartedScreen));
            EditorGUILayout.PropertyField(showGettingStarted);
        ...
        private void OnPropertyChange()
        {
            switch (m_changedPropertyName)
            {
                ...
                case nameof(ksReactorConfig.Server.DotNetPath):
                {
                    ksServerProjectUpdater.Instance.UpdateOutputPath();
                    ksServerScriptCompiler.Instance.BuildServerRuntime();
                    break;
